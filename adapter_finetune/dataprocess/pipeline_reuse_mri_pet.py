...
def main() -> None:
    ...
    ap.add_argument("--pairs_csv", type=Path, default='/home/ssddata/linshuijin/replicaLT/adapter_finetune/pairs0106_filtered.csv', help="CSV like plasma_mri_pet_matched_180d.csv")
    ap.add_argument("--nifti_root", type=Path, default='/mnt/nfsdata/nfsdata/ADNI/ADNI0103/NIFTI', help="ADNI0103 NIFTI root")
    ap.add_argument("--source_mri_root", type=Path, default='/mnt/nfsdata/nfsdata/LorenzoT/processed', help="Existing processed MRI root (LorenzoT)")
    ap.add_argument("--target_root", type=Path, default='/mnt/nfsdata/nfsdata/ADNI/ADNI0103/Coregistration', help="Coregistration root to store MRI/PET outputs")
    ap.add_argument("--logs_root", type=Path, default='/mnt/nfsdata/nfsdata/ADNI/ADNI0103/logs_pipeline0106_part_c1')
    ap.add_argument("--tmp_root", type=Path, default='/mnt/nfsdata/nfsdata/ADNI/ADNI0103/tmp_pipeline0106_part_c1')
