...
def parse_args():
    ...
    parser.add_argument("--checkpoint", type=str, default='/home/ssddata/linshuijin/replicaLT/adapter_v2/runs/03.08_3367502/ckpt/best.pt', help="checkpoint path, e.g. runs/<run>/ckpt/best.pt")
